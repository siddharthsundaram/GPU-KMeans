...
small_seq_times = parse_file("e2e/small_seq.txt")
small_gpu_times = parse_file("e2e/small_gpu.txt")
small_shmem_times = parse_file("e2e/small_shmem.txt")
small_kpp_times = parse_file("e2e/small_gpu_kpp.txt")
graph_e2e(small_seq_times, small_gpu_times, small_shmem_times, small_kpp_times, 16, 16, 2048, "small")

medium_seq_times = parse_file("e2e/medium_seq.txt")
medium_gpu_times = parse_file("e2e/medium_gpu.txt")
medium_shmem_times = parse_file("e2e/medium_shmem.txt")
medium_kpp_times = parse_file("e2e/medium_gpu_kpp.txt")
graph_e2e(medium_seq_times, medium_gpu_times, medium_shmem_times, medium_kpp_times, 16, 24, 16384, "medium")

large_seq_times = parse_file("e2e/large_seq.txt")
large_gpu_times = parse_file("e2e/large_gpu.txt")
large_shmem_times = parse_file("e2e/large_shmem.txt")
large_kpp_times = parse_file("e2e/large_gpu_kpp.txt")
